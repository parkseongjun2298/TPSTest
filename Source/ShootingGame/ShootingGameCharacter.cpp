...
void AShootingGameCharacter::SetupPlayerInputComponent( UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("RightLeft"), this, &AShootingGameCharacter::MoveForward);
	PlayerInputComponent->BindAxis(TEXT("UpDown"), this, &AShootingGameCharacter::MoveRight);
